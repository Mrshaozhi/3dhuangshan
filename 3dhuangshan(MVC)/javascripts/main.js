...
(function() {
  var linechartResize;
    $.ajax({
        ...
        data: 'version=v1&city=%E9%BB%84%E5%B1%B1%E5%8C%BA',
        dataType: 'JSON',
        error: function () {
            alert('网络错误');
        },
        success: function (res) {
            var tem1 = res.data[0].hours[0].tem.split("℃")[0];
            var tem2 = res.data[0].hours[1].tem.split("℃")[0];
            var tem3 = res.data[0].hours[2].tem.split("℃")[0];
            var tem4 = res.data[0].hours[3].tem.split("℃")[0];
            var tem5 = res.data[1].hours[0].tem.split("℃")[0];
            var tem6 = res.data[1].hours[1].tem.split("℃")[0];
            var tem7 = res.data[1].hours[2].tem.split("℃")[0];
            var tem8 = res.data[1].hours[3].tem.split("℃")[0];

            if (res.data[0].hours[0].day.indexOf("20") == -1) {
                tem1 = res.data[0].hours[0].tem.split("℃")[0];
                tem2 = res.data[0].hours[1].tem.split("℃")[0];
                tem3 = res.data[0].hours[2].tem.split("℃")[0];
                tem4 = res.data[0].hours[3].tem.split("℃")[0];
                tem5 = res.data[0].hours[4].tem.split("℃")[0];
                tem6 = res.data[0].hours[5].tem.split("℃")[0];
                tem7 = res.data[0].hours[6].tem.split("℃")[0];
                tem8 = res.data[0].hours[7].tem.split("℃")[0];
            }
            ...
            linechartResize = function () {               
                $.ajax({
                    type: 'post',
                    url: '../HS_Weather/WeatherBusiness2',
                    data: { judge: "second" },
                    dataType: 'JSON',
                    error: function () {
                        alert("服务器出错！");
                    ...
                    success: function (data) {
                        var TemMin = data.TemMin.split("*");
                        var TemMax = data.TemMax.split("*");

                        $("#linechart-1").sparkline([TemMax[TemMax.length - 14].split("℃")[0], TemMax[TemMax.length - 13].split("℃")[0], TemMax[TemMax.length - 12].split("℃")[0], TemMax[TemMax.length - 11].split("℃")[0], TemMax[TemMax.length - 10].split("℃")[0], TemMax[TemMax.length - 9].split("℃")[0], TemMax[TemMax.length - 8].split("℃")[0], TemMax[TemMax.length - 7].split("℃")[0], TemMax[TemMax.length - 6].split("℃")[0], TemMax[TemMax.length - 5].split("℃")[0]], {
                            type: "line",
                            width: "100%",
                            height: "226",
                            lineColor: "#d9534f",
                            fillColor: "rgba(241, 251, 255, 0.75)",
                            lineWidth: 2,
                            spotColor: "#d9534f",
                            minSpotColor: "#d9534f",
                            maxSpotColor: "#d9534f",
                        ...
                        $("#linechart-1").sparkline([TemMin[TemMin.length - 14].split("℃")[0], TemMin[TemMin.length - 13].split("℃")[0], TemMin[TemMin.length - 12].split("℃")[0], TemMin[TemMin.length - 11].split("℃")[0], TemMin[TemMin.length - 10].split("℃")[0], TemMin[TemMin.length - 9].split("℃")[0], TemMin[TemMin.length - 8].split("℃")[0], TemMin[TemMin.length - 7].split("℃")[0], TemMin[TemMin.length - 6].split("℃")[0], TemMin[TemMin.length - 5].split("℃")[0]], {
                            type: "line",
                            width: "100%",
                            height: "226",
                            lineColor: "#a5e1ff",
                ...
                $("#linechart-2").sparkline([tem1, tem2, tem3, tem4, tem5, tem6, tem7, tem8], {
                    type: "line",
                    width: "100%",
                    height: "226",
                    lineColor: "#a5e1ff",
            ...
            $(document).ready(function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        for (var NUM = 0; NUM < TYPE.length; NUM++) {                            
                            if (TYPE[NUM].indexOf("雪") != -1) {
                                snow++;
                            }
                            else if (TYPE[NUM].indexOf("雨") != -1) {
                                rain++;
                            }
                            else if (TYPE[NUM].indexOf("晴") != -1) {
                                sun++;
                            }
                            else if (TYPE[NUM].indexOf("多云") != -1) {
                                cloud++;
                            }
                        }
                        $("#pie-chart").sparkline([snow, rain, cloud, sun], {
                            type: "pie",
                            height: "220",
                            width: "220",
                            offset: "+90",
                ...
                */
                ...
                $("#event_add").click(function () {
                    var priority, title, time;
                    time = $("#timepicker-default").val();
                    title = time.replace(" PM","PM") + "&nbsp;&nbsp" + $("#event_title").val();
